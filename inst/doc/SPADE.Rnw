...
<<sampleData >>=
data_file_path = system.file(paste("extdata","SimulatedRawData.fcs",sep=.Platform$file.sep), package = "spade")
@
...
\begin{figure}
\centering
\includegraphics{{\Sexpr{sanitize(file.path(output_dir,"pdf","marker1.pdf"))}}}
\end{figure}

\begin{figure}
\centering
\includegraphics{{\Sexpr{sanitize(file.path(output_dir,"pdf","marker2.pdf"))}}}
\end{figure}
